...
public class IlbanSalesController {
	...
	public String removeilbanSales(@RequestParam(name = "billCode") String billCode,
			...
			@RequestParam(name = "payUsePoint") String payUsePoint, @RequestParam(name = "payMethod") String payMethod,
			@RequestParam(name = "payOkDate") String payOkDate, @RequestParam(name = "refundCode") String refundCode,
			@RequestParam(name = "afterUsePointPay") String afterUsePointPay,
			@RequestParam(name = "addPay") String addPay, @RequestParam(name = "deliveryPay") String deliveryPay,
			Model model) {
